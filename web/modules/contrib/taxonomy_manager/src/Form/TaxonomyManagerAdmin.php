...
class TaxonomyManagerAdmin extends ConfigFormBase {
  ...
  public function buildForm(array $form, FormStateInterface $form_state) {
    ...
    $form['taxonomy_manager_description_delimiter'] = [
      '#type' => 'textfield',
      '#size' => 5,
      '#required' => TRUE,
      '#title' => $this->t('Delimiter for term description'),
      '#default_value' => $config->get('taxonomy_manager_description_delimiter'),
      '#description' => $this->t('Specify a symbol(s) which will split term name from term description when importing terms.'),
    ];
  ...
  public function submitForm(array &$form, FormStateInterface $form_state) {
    ...
    $description_delimiter = $form_state->getValue('taxonomy_manager_description_delimiter');
    ...
    $config->set('taxonomy_manager_description_delimiter', $description_delimiter);
    $config->save();
