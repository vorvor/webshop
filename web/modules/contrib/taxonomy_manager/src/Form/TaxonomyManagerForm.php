...
class TaxonomyManagerForm extends FormBase {
  ...
  public function buildForm(array $form, FormStateInterface $form_state, ?VocabularyInterface $taxonomy_vocabulary = NULL) {
    ...
    $form['toolbar']['export'] = [
      ...
      '#access' => $current_user->hasPermission('taxonomy manager export csv for ' . $taxonomy_vocabulary->id()),
    ];
    ...
    $form['toolbar']['miniexport'] = [
      ...
      '#access' => $current_user->hasPermission('taxonomy manager export list for ' . $taxonomy_vocabulary->id()),
    ];
