...
/**
 * Provides dynamic permissions of the taxonomy manager module.
 *
 * @see taxonomy_manager.permissions.yml
 */
class TaxonomyManagerPermissions implements ContainerInjectionInterface {
  ...
  protected function buildPermissions(VocabularyInterface $vocabulary) {
    ...
    return [
      "taxonomy manager export csv for $id" => ['title' => $this->t('%vocabulary: Export CSV', $args)],
      "taxonomy manager export list for $id" => ['title' => $this->t('%vocabulary: Export List', $args)],
    ];
  }
